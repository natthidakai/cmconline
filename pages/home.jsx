...
import BHTWN1 from './assert/images/cuvee.jpg'
import BHRAMC from './assert/images/cybiq-ram.jpg'
import CTKSCP from './assert/images/kaset.jpg'
            ...
            <Container className='py-5'>
                ...
                <Row className='pt-2 justify-content-center mb-3'>
                    {projects.slice(0, visibleProjects).map((project) => (
                        <Col key={project.ProjectID} xl="3" sm="10" xs="10" className=''>
                            ...
                            <div className='project-shadows border-radius'>
                                <div className='hoverImageWrapper'>
                                <Link href="step/1"><Image src={projectImages[project.ProjectID] || Default} alt={project.BrandName} className='img-100 p-0 hoverImage' /></Link>
                                </div>
                                ...
                                <Col className='bg-white p-4 border-radius-bottom'>
                                    ...
                                    <div className='price th'>เริ่มต้น {project.MINPrice} ล้านบาท</div>
                                </Col>
                            </div>
                        </Col>
                    ))}
                ...
                {visibleProjects < projects.length && (
                    <div className="justify-content-center mt-5">
                        <Button onClick={loadMoreProjects} className="btn th btn-xl">ดูเพิ่มเติม</Button>
                    </div>
                )}
